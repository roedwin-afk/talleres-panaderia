...
const cuposMaximos = parsed.data.cuposMaximos;
if (typeof cuposMaximos === "number" && cuposActuales >= cuposMaximos) {
  console.log(`⚠️ El taller "${slug}" ya está en su cupo máximo (${cuposMaximos}). No se incrementa más.`);
  process.exit(0);
}
